...
public enum EPrintStatus
{
    ...
    /// <summary>已连接。JS: Connected=2。</summary>
    Connected = 2,

    /// <summary>检测中。JS: Checking=3。</summary>
    Checking = 3,

    /// <summary>准备打印。JS: ReadyPrint=4。</summary>
    ReadyPrint = 4,

    /// <summary>发送中。JS: Sending=5。</summary>
    Sending = 5,

    /// <summary>打印中。JS: Printing=6。</summary>
    Printing = 6,

    /// <summary>已暂停。JS: Paused=7。</summary>
    Paused = 7,

    /// <summary>已取消。JS: Cancel=8。</summary>
    Cancel = 8
}

/// <summary>
/// 数据发送模式。对应 JS <c>t.EDataSendMode</c>。
/// </summary>
public enum EDataSendMode
{
    /// <summary>无。JS: None=0。</summary>
    None = 0,

    /// <summary>可打印。JS: Printable=1。</summary>
    Printable = 1,

    /// <summary>分页键。JS: PageKey=2。</summary>
    PageKey = 2
}
...
/// <summary>
/// 打印机可打印状态。对应 JS <c>t.LPA_Printable</c>。
/// 表示打印机硬件状态（可打印、缺纸、高温等）。
/// </summary>
public enum LpaPrintable
{
    /// <summary>可打印。JS: DZIP_PRINTABLE=0。</summary>
    DzipPrintable = 0,

    /// <summary>正在打印。JS: DZIP_ISPRINTING=1。</summary>
    DzipIsPrinting = 1,

    /// <summary>正在旋转。JS: DZIP_ISROTATING=2。</summary>
    DzipIsRotating = 2,

    /// <summary>无作业。JS: DZIP_NOJOB=10。</summary>
    DzipNoJob = 10,

    /// <summary>页面未就绪。JS: DZIP_PAGENOTREADY=11。</summary>
    DzipPageNotReady = 11,

    /// <summary>作业已取消。JS: DZIP_JOBCANCELED=12。</summary>
    DzipJobCanceled = 12,

    /// <summary>环境未就绪。JS: DZIP_ENVNOTREADY=20。</summary>
    DzipEnvNotReady = 20,

    /// <summary>电压过低。JS: DZIP_VOLTOOLOW=30。</summary>
    DzipVoltTooLow = 30,

    /// <summary>电压过高。JS: DZIP_VOLTOOHIGH=31。</summary>
    DzipVoltTooHigh = 31,

    /// <summary>热敏头未找到。JS: DZIP_TPHNOTFOUND=32。</summary>
    DzipTphNotFound = 32,

    /// <summary>热敏头过热。JS: DZIP_TPHTOOHOT=33。</summary>
    DzipTphTooHot = 33,

    /// <summary>盖子已打开。JS: DZIP_COVEROPENED=34。</summary>
    DzipCoverOpened = 34,

    /// <summary>缺纸。JS: DZIP_NO_PAPER=35。</summary>
    DzipNoPaper = 35,

    /// <summary>碳带舱可打开。JS: DZIP_RIBBONCANOPENED=36。</summary>
    DzipRibbonCanOpened = 36,

    /// <summary>无碳带。JS: DZIP_NO_RIBBON=37。</summary>
    DzipNoRibbon = 37,

    /// <summary>碳带不匹配。JS: DZIP_UNMATCHED_RIBBON=38。</summary>
    DzipUnmatchedRibbon = 38,

    /// <summary>热敏头过冷。JS: DZIP_TPHTOOCOLD=39。</summary>
    DzipTphTooCold = 39,

    /// <summary>碳带已用尽。JS: DZIP_USEDUP_RIBBON=40。</summary>
    DzipUsedUpRibbon = 40,

    /// <summary>碳带已用尽 2。JS: DZIP_USEDUP_RIBBON2=41。</summary>
    DzipUsedUpRibbon2 = 41,

    /// <summary>无标签。JS: DZIP_NO_LABEL=42。</summary>
    DzipNoLabel = 42,

    /// <summary>标签不匹配。JS: DZIP_UNMATCHED_LABEL=43。</summary>
    DzipUnmatchedLabel = 43,

    /// <summary>标签已用尽。JS: DZIP_USEDUP_LABEL=44。</summary>
    DzipUsedUpLabel = 44,

    /// <summary>无碳带 2。JS: DZIP_NO_RIBBON2=45。</summary>
    DzipNoRibbon2 = 45,

    /// <summary>碳带不匹配 2。JS: DZIP_UNMATCHED_RIBBON2=46。</summary>
    DzipUnmatchedRibbon2 = 46,

    /// <summary>标签舱可打开。JS: DZIP_LABELCANOPENED=50。</summary>
    DzipLabelCanOpened = 50
}
